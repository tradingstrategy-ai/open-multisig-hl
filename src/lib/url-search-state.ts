/**
 * Generic helpers for serialising/deserialising state to/from URL query parameters.
 *
 ...
 * to write back — omitting any values that match their defaults to keep URLs clean.
 */
 ...
 * a leading `?`.
 */
export function serialiseSearchParams<S extends ParamSchema>(
